import { DocumentNode } from 'apollo-upload-client/node_modules/graphql';
import { ApolloLink, FetchResult } from 'apollo-upload-client/node_modules/@apollo/src/link/core';
import { Cache, ApolloCache } from 'apollo-upload-client/node_modules/@apollo/src/cache';
import { Observable, Concast } from 'apollo-upload-client/node_modules/@apollo/src/utilities';
import { QueryOptions, WatchQueryOptions, SubscriptionOptions, MutationOptions, ErrorPolicy, MutationFetchPolicy } from 'apollo-upload-client/node_modules/@apollo/src/core/watchQueryOptions';
import { ObservableQuery } from 'apollo-upload-client/node_modules/@apollo/src/core/ObservableQuery';
import { NetworkStatus } from 'apollo-upload-client/node_modules/@apollo/src/core/networkStatus';
import { ApolloQueryResult, OperationVariables, MutationUpdaterFunction, OnQueryUpdated, InternalRefetchQueriesInclude, InternalRefetchQueriesOptions, InternalRefetchQueriesMap } from 'apollo-upload-client/node_modules/@apollo/src/core/types';
import { LocalState } from 'apollo-upload-client/node_modules/@apollo/src/core/LocalState';
import { QueryStoreValue } from 'apollo-upload-client/node_modules/@apollo/src/core/QueryInfo';
