import { ExecutionResult, DocumentNode } from 'apollo-upload-client/node_modules/graphql';
import { ApolloLink, FetchResult, GraphQLRequest } from 'apollo-upload-client/node_modules/@apollo/src/link/core';
import { ApolloCache, DataProxy } from 'apollo-upload-client/node_modules/@apollo/src/cache';
import { Observable } from 'apollo-upload-client/node_modules/@apollo/src/utilities';
import { UriFunction } from 'apollo-upload-client/node_modules/@apollo/src/link/http';
import { ObservableQuery } from 'apollo-upload-client/node_modules/@apollo/src/core/ObservableQuery';
import { ApolloQueryResult, DefaultContext, OperationVariables, Resolvers, RefetchQueriesOptions, RefetchQueriesResult, RefetchQueriesInclude } from 'apollo-upload-client/node_modules/@apollo/src/core/types';
import { QueryOptions, WatchQueryOptions, MutationOptions, SubscriptionOptions } from 'apollo-upload-client/node_modules/@apollo/src/core/watchQueryOptions';
import { FragmentMatcher } from 'apollo-upload-client/node_modules/@apollo/src/core/LocalState';
