import { SelectionSetNode } from 'apollo-upload-client/node_modules/graphql';
import { NormalizedCache, InMemoryCacheConfig } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/types';
import { KeyFieldsContext } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/policies';
import { Reference, StoreValue, StoreObject, DeepMerger } from 'apollo-upload-client/node_modules/@apollo/src/utilities';
