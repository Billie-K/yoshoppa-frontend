...
import { StoreValue, StoreObject, Reference } from 'apollo-upload-client/node_modules/@apollo/src/utilities';
import { NormalizedCache, NormalizedCacheObject } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/types';
import { Policies, StorageType } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/policies';
import { Cache } from 'apollo-upload-client/node_modules/@apollo/src/cache/core/types/Cache';
import { SafeReadonly, Modifier, Modifiers, ToReferenceFunction, CanReadFunction } from 'apollo-upload-client/node_modules/@apollo/src/cache/core/types/common';
