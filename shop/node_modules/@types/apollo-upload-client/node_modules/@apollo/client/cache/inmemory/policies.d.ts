import { InlineFragmentNode, FragmentDefinitionNode, SelectionSetNode, FieldNode } from 'apollo-upload-client/node_modules/graphql';
import { FragmentMap, StoreValue, StoreObject, Reference, isReference } from 'apollo-upload-client/node_modules/@apollo/src/utilities';
import { IdGetter, MergeInfo, ReadMergeModifyContext } from "apollo-upload-client/node_modules/@apollo/src/cache/inmemory/types";
import { InMemoryCache } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/inMemoryCache';
import { SafeReadonly, FieldSpecifier, ToReferenceFunction, ReadFieldFunction, ReadFieldOptions, CanReadFunction } from 'apollo-upload-client/node_modules/@apollo/src/cache/core/types/common';
import { WriteContext } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/writeToStore';
