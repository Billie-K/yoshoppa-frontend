import 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/fixPolyfills';
import { DocumentNode } from 'apollo-upload-client/node_modules/graphql';
import { ApolloCache } from 'apollo-upload-client/node_modules/@apollo/src/cache/core/cache';
import { Cache } from 'apollo-upload-client/node_modules/@apollo/src/cache/core/types/Cache';
import { StoreObject, Reference } from 'apollo-upload-client/node_modules/@apollo/src/utilities';
import { InMemoryCacheConfig, NormalizedCacheObject } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/types';
import { makeVar } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/reactiveVars';
import { Policies } from 'apollo-upload-client/node_modules/@apollo/src/cache/inmemory/policies';
