...
export declare namespace Portal {
    var Group: <TTag extends React.ElementType<any> = React.ExoticComponent<{
        children?: React.ReactNode;
    }>>(props: Pick<import("@headlessui/react/dist/types").PropsOf<TTag>, Exclude<keyof import("@headlessui/react/dist/types").PropsOf<TTag>, "children" | "as" | "refName" | "className">> & {
        as?: TTag | undefined;
