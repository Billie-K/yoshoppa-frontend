...
import type { Store } from 'jotai/core/store';
...
export declare const createScopeContainer: (initialValues?: Iterable<readonly [Atom<unknown>, unknown]> | undefined, unstable_createStore?: ((initialValues?: Iterable<readonly [{
    ...
    set: <Value_5, Update, Result extends void | Promise<void>>(atom: import("jotai/core/atom").WritableAtom<Value_5, Update, Result>, update: Update) => Result;
    sub: (atom: {
        toString: () => string;
        debugLabel?: string;
        read: (get: {
    ...
    SECRET_INTERNAL_store: {
        r: <Value_6>(readingAtom: Atom<Value_6>, version?: import("jotai/core/store").VersionObject | undefined) => import("jotai/core/store").AtomState<Value_6>;
        w: <Value_7, Update_1, Result_1 extends void | Promise<void>>(writingAtom: import("jotai/core/atom").WritableAtom<Value_7, Update_1, Result_1>, update: Update_1, version?: import("jotai/core/store").VersionObject | undefined) => Result_1;
        c: (_atom: {
            toString: () => string;
            debugLabel?: string;
            read: (get: {
