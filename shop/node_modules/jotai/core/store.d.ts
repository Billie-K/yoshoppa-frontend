import type { Atom, WritableAtom } from 'jotai/core/atom';
import type { SuspensePromise } from 'jotai/core/suspensePromise';
...
export declare const createStoreForExport: (initialValues?: Iterable<readonly [AnyAtom, unknown]> | undefined) => {
    ...
    asyncGet: <Value_1>(atom: Atom<Value_1>) => Promise<ResolveType<Value_1>>;
