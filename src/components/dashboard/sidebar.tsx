...
const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ className }) => {
  ...
  return (
    <aside className={className}>
      <div className="px-10 py-8 mb-5 overflow-hidden border rounded border-border-200 bg-accent">
        <h3 className="pb-4 mb-4 text-light font-semibold border-b border-dashed border-border-200 text-heading">
          {t('text-wallet-points')} 
        </h3>

        <div className="grid grid-cols-3">
          <div className="mb-2 flex flex-col items-center justify-center space-y-1 border-r border-dashed border-gray-200 py-2 px-2 text-[13px] font-semibold capitalize text-heading text-light">
          ...
          <div className="mb-2 flex flex-col items-center justify-center space-y-1 py-2 px-2 text-[13px] font-semibold capitalize text-heading text-light">
