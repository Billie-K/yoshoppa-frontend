...
const Header = ({ layout }: { layout: string }) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'fixed flex justify-between items-center w-11/12 h-14 \
          md:h-16 lg:h-22 px-4 lg:px-8 py-5 z-50 border-b \
          border-border-200 transition-transform duration-300 \
          transform-gpu backdrop-blur-sm bg-green-500/30 rounded-lg mt-2 ml-10',
          {
