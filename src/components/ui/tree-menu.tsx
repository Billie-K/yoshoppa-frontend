  ...
  return (
    <>
      ...
      >
        <button
          className={cn(
            'flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-white transition-all ease-in-expo',
            isOpen ? 'text-white' : 'text-green-200',
