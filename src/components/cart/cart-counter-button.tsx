...
const CartCounterButton = () => {
  ...
  return (
    <button
      className="hidden product-cart lg:flex flex-col items-center justify-center p-3 pt-3.5 fixed top-1/2 -mt-12 ltr:right-0 rtl:left-0 z-40 shadow-900 rounded backdrop-blur-sm bg-green-500/30 mr-2 text-green-500 text-sm font-semibold transition-colors duration-200 focus:outline-none hover:bg-accent-hover/30"
    ...
    >
      ...
      <span className="bg-light rounded w-full py-2 px-2 text-green-500 mt-3">
        {totalPrice}
      </span>
    </button>
  );
