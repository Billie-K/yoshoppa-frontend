...
> = ({ notFound, categories, loading, className }) => {
  ...
  return (
    <aside
      className={`lg:sticky lg:top-22 h-full xl:w-72 hidden xl:block bg-transparent ${className}`}
    >
      {!isMobile && (
        <div className="max-h-full overflow-hidden flex-grow ml-2 rounded my-3 bg-green-500 ">
          <Scrollbar
